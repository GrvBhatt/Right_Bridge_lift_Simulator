...
void screen1()
{
    ...
    char str1[]="RAJARAJESWARI COLLEGE OF ENGINEERING";
    drawstring(str1,-0.5,0.9,0.0);
    //glColor3f(31.0f/255.0f, 138.0f/255.0f, 192.0f/255.0f);
    glColor3f(1.0, 1.0, 1.0);
    ...
    char str6[]="ABHISHEK PANDEY     (1RR19CS003)";
    drawstring(str6,-0.5,0.4,0.0);
    char str7[]="GAURAV KUMAR BHATT   (1RR19CS037)";
    drawstring(str7,-0.5,0.3,0.0);
    glColor3f(0.2,0.8,0.5);
    char str8[]="UNDER THE GUIDANCE OF :";
    drawstring(str8,-0.5,0.1,0.0);
    glColor3f(1.0,1.0,0.0);
    char str9[]="Mrs . CHAITRA S    (Asst.prof. Dept of CSE)";
